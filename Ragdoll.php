...
<style>
    :root {
        --brand-accent: #e11d48;
        --cat-theme: #93c5fd; /* Soft Blue to match Ragdoll's blue eyes */
        --soft-bg: #f8fafc;
    }
...
<section class="relative bg-blue-100 pt-19 pb-40 px-6 overflow-hidden">
    <div class="absolute top-0 right-0 w-96 h-96 bg-blue-200 opacity-20 rounded-full -mr-20 -mt-20 blur-3xl"></div>
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div class="md:w-1/2 animate__animated animate__fadeInLeft">
            <span class="bg-blue-500/10 text-blue-600 px-5 py-2 rounded-full font-bold text-xs uppercase tracking-widest border border-blue-500/20">Breed Spotlight</span>
            <h1 class="text-6xl md:text-8xl font-extrabold text-gray-800 mt-6 mb-8 drop-shadow-sm leading-tight">The <?php echo $breed; ?></h1>
            <p class="text-2xl text-gray-600 mb-10 leading-relaxed max-w-xl">Docile, soft, and famous for their blue eyes. Discover why the Ragdoll is the ultimate "puppy-cat" for loving families.</p>
            <div class="flex flex-wrap gap-5">
                <a href="#overview" class="bg-blue-500 text-white px-10 py-5 rounded-2xl font-bold shadow-2xl hover:bg-blue-600 transition-all transform hover:-translate-y-1">Ragdoll Guide</a>
            </div>
        </div>
        <div class="md:w-1/2 mt-16 md:mt-0 flex justify-center animate__animated animate__zoomIn">
            <img src="uploads/breeds/inner/THERAGDOL.JPG" 
                 class="w-full max-w-lg rounded-[4rem] shadow-2xl border-[15px] border-white/40 float-anim" alt="Ragdoll Cat">
        </div>
    </div>
</section>
...
<div id="overview" class="max-w-6xl mx-auto -mt-24 relative z-20 px-4">
    <div class="bg-white rounded-[3rem] shadow-2xl p-10 md:p-16 border border-gray-100 reveal">
        <h2 class="text-3xl font-bold text-center mb-10 text-gray-800 italic underline decoration-blue-200">At a Glance</h2>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center p-6 bg-blue-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-blue-500 mt-3">4.5 - 9 kg</h4>
            </div>
            <div class="text-center p-6 bg-orange-50 rounded-3xl product-card">
                <p class="text-gray-400 text-xs uppercase font-bold">Coat Type</p>
                <h4 class="text-3xl font-extrabold text-orange-500 mt-3">Silky Semi-Long</h4>
            </div>
            <div class="text-center p-6 bg-green-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-green-500 mt-3">12 - 17 Yrs</h4>
            </div>
            <div class="text-center p-6 bg-purple-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-purple-500 mt-3">Affectionate</h4>
            </div>
        </div>
    </div>
</div>
...
<section class="section-spacing px-6 mt-10">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-blue-800 mb-8 leading-tight italic">Large cats with <br>specific dietary needs</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Ragdolls are slow growers and take up to 4 years to reach full size. They need balanced nutrition to maintain their large muscle mass and support bone health without excessive weight gain. Explore <?php echo $brand; ?>'s premium Ragdoll diet range.</p>
            <div class="grid grid-cols-2 gap-6">
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-blue-400">
                    <img src="uploads/breeds/inner/ragkibble.jpg" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Ragdoll Adult Kibble</p>
                </div>
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-blue-400">
                    <img src="uploads/breeds/inner/ragdolwet.jpg" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Hydration Wet Gravy</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/ragdolfood.jpg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Ragdoll Nutrition">
        </div>
    </div>
</section>
...
<section class="section-spacing px-6 bg-white">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/ragdolplay.jpg" class="rounded-[4rem] shadow-2xl border-b-[20px] border-blue-200" alt="Cat Play">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-blue-800 mb-8 italic">Ragdolls are floor-dwellers</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Unlike most cats, Ragdolls often prefer staying low to the ground. They love interactive tunnels, floor-level scratching pads, and chasing balls on tracks. Ensure their play area is safe and easily accessible.</p>
            <div class="space-y-4">
                <div class="flex items-center gap-5 p-5 bg-blue-50 rounded-2xl border-l-8 border-blue-500 product-card">
                    <span class="text-2xl">🎢</span>
                    <span class="text-lg font-bold text-blue-900">Ball Track & Puzzle Feeders</span>
                </div>
                <div class="flex items-center gap-5 p-5 bg-blue-50 rounded-2xl border-l-8 border-blue-500 product-card">
                    <span class="text-2xl">🛋️</span>
                    <span class="text-lg font-bold text-blue-900">Plush Orthopedic Floor Beds</span>
                </div>
            </div>
        </div>
    </div>
...
<section class="section-spacing px-6 py-16 bg-[#fafafa]">
    <div class="feeding-section-wrapper reveal">
        <div class="mb-10 text-center">
            ...
            <p class="text-gray-500 font-medium">Nutritional schedule for a growing <?php echo $breed; ?>.</p>
        </div>
                ...
                <table class="w-full text-left border-collapse text-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr class="hover:bg-emerald-50/50 transition-colors">
                            ...
                            <td class="px-6 py-5">60-100g kibble</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">4-5 Meals</span></td>
                            <td class="px-6 py-5 italic text-sm">High protein for muscle development</td>
                        </tr>
                        <tr class="hover:bg-emerald-50/50 transition-colors">
                            <td class="px-6 py-5 font-bold">Adult (1-10y)</td>
                            <td class="px-6 py-5">90-140g kibble</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">2-3 Meals</span></td>
                            <td class="px-6 py-5 italic text-sm">Watch calories to prevent obesity</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="mt-8 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
            ...
            <p class="text-gray-600 text-sm"><strong>Note:</strong> Ragdolls go "limp" when held, but they are heavy. Always support their hindquarters when picking them up!</p>
        </div>
    </div>
</section>
...
<section class="section-spacing px-6 bg-blue-100">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        <div class="md:w-1/2 reveal"> 
            <img src="uploads/breeds/inner/ragdollvetcare.jpg" class="w-full h-auto rounded-[3rem] shadow-2xl transform hover:scale-105 transition-transform duration-500" alt="Ragdoll Vet Care">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-3xl lg:text-4xl font-bold text-blue-800 mb-10 italic leading-tight">Regular health screenings for a joyful life</h2>
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    <div class="bg-blue-200 p-5 rounded-full text-4xl shadow-inner">🧬</div>
                    <div>
                        <h4 class="font-bold text-xl text-gray-800">Heart Health</h4>
                        <p class="text-gray-500 text-lg">Ragdolls can be prone to HCM; annual cardiac scans are recommended.</p>
                    </div>
                </div>
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    <div class="bg-blue-200 p-5 rounded-full text-4xl shadow-inner">🦷</div>
                    <div>
                        <h4 class="font-bold text-xl text-gray-800">Gums & Teeth</h4>
                        <p class="text-gray-500 text-lg">Watch for gingivitis early to maintain their "Gentle Giant" smile.</p>
                    </div>
                </div>
            </div>
        </div>
