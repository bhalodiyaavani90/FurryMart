...
<style>
    :root {
        --brand-accent: #e11d48;
        --cat-theme: #fb923c; /* Warm Orange to match the classic Ginger Tabby */
        --soft-bg: #fffbf9;
    }
...
<section class="relative bg-orange-400 pt-19 pb-40 px-6 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div class="md:w-1/2 animate__animated animate__fadeInLeft">
            <span class="bg-white/20 text-white px-5 py-2 rounded-full font-bold text-xs uppercase tracking-widest border border-white/30">Pattern Spotlight</span>
            <h1 class="text-6xl md:text-8xl font-extrabold text-white mt-6 mb-8 drop-shadow-lg leading-tight">The <?php echo $breed; ?></h1>
            <p class="text-2xl text-white/90 mb-10 leading-relaxed max-w-xl">Friendly, smart, and full of personality. Discover why the Tabby is the world's most iconic and loved household feline.</p>
            <div class="flex flex-wrap gap-5">
                <a href="#overview" class="bg-white text-gray-900 px-10 py-5 rounded-2xl font-bold shadow-2xl hover:bg-gray-100 transition-all transform hover:-translate-y-1">Tabby Guide</a>
            </div>
        </div>
        <div class="md:w-1/2 mt-16 md:mt-0 flex justify-center animate__animated animate__zoomIn">
            <img src="uploads/breeds/inner/tabby_hero.png" 
                 class="w-full max-w-lg rounded-[4rem] shadow-2xl border-[15px] border-white/20 float-anim" alt="Tabby Cat">
        </div>
    </div>
</section>
...
<div id="overview" class="max-w-6xl mx-auto -mt-24 relative z-20 px-4">
    <div class="bg-white rounded-[3rem] shadow-2xl p-10 md:p-16 border border-gray-100 reveal">
        <h2 class="text-3xl font-bold text-center mb-10 text-gray-800 italic underline decoration-orange-300">At a Glance</h2>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center p-6 bg-orange-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-orange-500 mt-3">3.5 - 6 kg</h4>
            </div>
            <div class="text-center p-6 bg-blue-50 rounded-3xl product-card">
                <p class="text-gray-400 text-xs uppercase font-bold">Pattern Type</p>
                <h4 class="text-3xl font-extrabold text-blue-500 mt-3">Striped/Spotted</h4>
            </div>
            <div class="text-center p-6 bg-green-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-green-500 mt-3">12 - 18 Yrs</h4>
            </div>
            <div class="text-center p-6 bg-purple-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-purple-500 mt-3">High</h4>
            </div>
        </div>
    </div>
</div>
...
<section class="section-spacing px-6 mt-10">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-orange-700 mb-8 leading-tight italic">Tabby cats need <br>balanced feline diets</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Since "Tabby" refers to a coat pattern found across many breeds, a balanced diet is essential. They thrive on a mix of wet and dry food to maintain hydration and lean muscle mass. Explore <?php echo $brand; ?>'s range for active Tabby-marked cats.</p>
            <div class="grid grid-cols-2 gap-6">
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-orange-500">
                    <img src="uploads/breeds/inner/tabby_kibble.png" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Balanced Adult Mix</p>
                </div>
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-orange-500">
                    <img src="uploads/breeds/inner/salmon_wet.png" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Salmon Gravy Pouch</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/tabby_nutrition.jpg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Tabby Nutrition">
        </div>
    </div>
</section>
...
<section class="bg-[#FFF8E1] section-spacing px-6">
    <div class="max-w-7xl mx-auto text-center mb-16 reveal">
        <h2 class="text-5xl font-bold text-orange-900 mb-6 italic underline decoration-orange-300">Grooming Your Tabby</h2>
        <p class="text-xl text-orange-700">Grooming needs vary based on coat length, but weekly brushing keeps the pattern vivid.</p>
    </div>
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-orange-400 product-card">
            <img src="uploads/breeds/inner/cat_shampoo_all.png" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">All-Coat Shampoo</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-blue-400 product-card">
            <img src="uploads/breeds/inner/massage_brush_cat.png" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Rubber Massage Brush</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-pink-400 product-card">
            <img src="uploads/breeds/inner/claw_trim.png" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Ergonomic Claw Trimmer</h3>
...
<section class="section-spacing px-6 bg-white">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/cat_litter.jpg" class="rounded-[4rem] shadow-2xl border-b-[20px] border-orange-200" alt="Litter Training">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-orange-800 mb-8 italic">Cleanliness is an instinct</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Tabbies are naturally clean and typically adapt quickly to litter boxes. Provide high-quality clumping litter and a private location to help them feel secure and maintain their hygiene habits.</p>
            <div class="space-y-4">
                <div class="flex items-center gap-5 p-5 bg-orange-50 rounded-2xl border-l-8 border-orange-500 product-card">
                    <span class="text-2xl">🧹</span>
                    <span class="text-lg font-bold text-orange-900">Anti-Tracking Litter Mats</span>
                </div>
                <div class="flex items-center gap-5 p-5 bg-orange-50 rounded-2xl border-l-8 border-orange-500 product-card">
                    <span class="text-2xl">🏠</span>
                    <span class="text-lg font-bold text-orange-900">Hooded Privacy Litter Boxes</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="feeding-section-wrapper reveal">
        <div class="mb-10 text-center">
            <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 mb-2 italic">
                Feeding <span class="text-orange-600 underline decoration-orange-200 decoration-4 underline-offset-4">Guidelines</span>
            </h2>
                ...
                <table class="w-full text-left border-collapse text-gray-700">
                    <thead>
                        <tr class="table-head-green">
                            <th class="px-6 py-4 text-xs uppercase font-bold">Age Group</th>
                            <th class="px-6 py-4 text-xs uppercase font-bold">Daily Portion</th>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr class="hover:bg-orange-50/50 transition-colors">
                            <td class="px-6 py-5 font-bold">Kitten (2-12m)</td>
                            <td class="px-6 py-5">40-60g kibble</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">4-5 Meals</span></td>
                            <td class="px-6 py-5 italic text-sm">High protein for endless play energy</td>
                        </tr>
                        <tr class="hover:bg-orange-50/50 transition-colors">
                            <td class="px-6 py-5 font-bold">Adult (1-10y)</td>
                            <td class="px-6 py-5">60-80g kibble</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">2-3 Meals</span></td>
                            <td class="px-6 py-5 italic text-sm">Ensure fresh water is always nearby</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="mt-8 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
            ...
            <p class="text-gray-600 text-sm"><strong>Note:</strong> Tabbies are prone to weight gain. Use interactive puzzle feeders to slow down eating!</p>
        </div>
    </div>
</section>

<section class="section-spacing px-6 bg-orange-50">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-orange-800 mb-8 italic">Sharp Minds & Quick Paws</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Tabbies are often great hunters. They need toys that mimic the movement of birds and mice. Vertical cat trees and window perches allow them to monitor their environment safely from indoors.</p>
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-white p-4 rounded-2xl shadow-md border-l-4 border-orange-500">
                    <p class="font-bold text-sm">Feather Wands</p>
                </div>
                <div class="bg-white p-4 rounded-2xl shadow-md border-l-4 border-orange-500">
                    <p class="font-bold text-sm">Catnip Mice</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/cat_playtime.jpg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Cat Play">
        </div>
    </div>
</section>
...
<section class="bg-purple-50 section-spacing px-6">
    <div class="max-w-5xl mx-auto flex flex-col items-center text-center reveal">
        <h2 class="text-5xl font-bold text-purple-900 mb-8 italic">New Tabby Kitten? Get Setup!</h2>
        <div class="bg-white p-12 rounded-[4rem] shadow-2xl flex flex-col md:flex-row gap-12 items-center">
            <img src="https://images.pexels.com/photos/104827/cat-pet-animal-domestic-104827.jpeg" class="w-64 h-64 rounded-full object-cover border-8 border-purple-100">
            <div class="text-left">
                <h3 class="text-2xl font-bold mb-4">The <?php echo $brand; ?> Kitten Kit</h3>
                <ul class="text-gray-600 space-y-3 mb-8">
                    <li>✓ High-protein growth kitten kibble</li>
                    <li>✓ Interactive hunting toys & laser pointers</li>
                    <li>✓ Ultra-soft plush sleeping beds</li>
                </ul>
...
<section class="section-spacing px-6 bg-sky-100">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        <div class="md:w-1/2 reveal"> 
            <img src="uploads/breeds/inner/cat_checkup.jpg" class="w-full h-auto rounded-[3rem] shadow-2xl transform hover:scale-105 transition-transform duration-500" alt="Cat Health Care">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-3xl lg:text-4xl font-bold text-blue-800 mb-10 italic leading-tight">Foundation for a long, happy life</h2>
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-sky-500 product-card flex items-center gap-6">
                    ...
                    <div>
                        <h4 class="font-bold text-xl text-gray-800">Vaccinations</h4>
                        <p class="text-gray-500 text-lg">Regular FVRCP and Rabies shots are vital for domestic cats.</p>
                    </div>
                </div>
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-sky-500 product-card flex items-center gap-6">
                    <div class="bg-sky-100 p-5 rounded-full text-4xl shadow-inner">💧</div>
                    <div>
                        <h4 class="font-bold text-xl text-gray-800">Kidney Care</h4>
                        <p class="text-gray-500 text-lg">Encourage hydration to prevent FLUTD and renal issues.</p>
                    </div>
                </div>
            </div>
        </div>
