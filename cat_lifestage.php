...
$brand_res = mysqli_query($conn, "SELECT DISTINCT brand_name FROM products WHERE is_available = 1 AND life_stage != '' AND main_cat_id = 3 ORDER BY brand_name ASC");
...
$sql = "SELECT p.*, v.price, v.mrp, v.weight_size, v.stock_qty, v.id as variant_id 
        ...
        WHERE p.is_available = 1 AND p.main_cat_id = 3";
...
<style>
    ...
    .hero-glimmer { position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(rgba(15,28,63,0.7), rgba(15,28,63,0.7)), url('https://images.unsplash.com/photo-1548199973-03cce0bbc87b?auto=format&fit=crop&w=1350&q=80'); background-size: cover; background-position: center; animation: slowReflect 20s infinite alternate; z-index: -1; }
    ...
    /* Diet Mark - VEG/NON-VEG Indicator (Only for Food Products) */
    .diet-mark { 
        position: absolute; top: 20px; left: 20px; 
        width: 18px; height: 18px; border: 2.5px solid; 
        display: flex; align-items: center; justify-content: center; 
        z-index: 5; background: #fff; border-radius: 3px; 
        box-shadow: 0 2px 8px rgba(0,0,0,0.1);
    }
    .veg { border-color: var(--veg); } 
    .veg::after { content: ''; width: 9px; height: 9px; background: var(--veg); border-radius: 50%; }
    .nonveg { border-color: var(--nonveg); } 
    .nonveg::after { 
...
<div class="hero-vault animate__animated animate__fadeIn">
    ...
    <div class="animate__animated animate__zoomIn" style="text-align: center;">
        <h1>Cat Life Stage Products</h1>
        <p style="font-weight: 800; text-transform: uppercase; letter-spacing: 4px; color: rgba(255,255,255,0.95);">Age-Optimized Nutrition & Care</p>
    </div>
</div>
...
<div class="catalog-viewport">
    <aside class="sidebar-filters">
        ...
        <div class="filter-group">
            ...
            <a href="cat_lifestage.php" class="st-link <?php if(!$current_stage) echo 'active'; ?>">All Stages</a>
            <a href="?stage=Kitten" class="st-link <?php if($current_stage=='Puppy') echo 'active'; ?>">Kitten</a>
        ...
        <div class="modal-console">
            <div class="console-header">
                ...
                <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                    ...
                    <span id="qv-diet-badge" class="badge-pill" style="display:none;"></span>
...
function launchQuickView(p) {
    ...
    // Diet Badge (VEG/NON-VEG) - Only show for food products
