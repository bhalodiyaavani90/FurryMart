...
<style>
  :root {
        --brand-accent: #e11d48;
        --shih-tzu-theme: #f8bbd0; /* Soft Pink Theme */
        --soft-bg: #fffbfd;
    }
...
<section class="relative bg-[#f8bbd0] pt-19 pb-40 px-6 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div class="md:w-1/2 animate__animated animate__fadeInLeft">
            ...
            <p class="text-2xl text-white/90 mb-10 leading-relaxed max-w-xl">Affectionate, happy, and outgoing. Discover why this "Lion Dog" is the ultimate indoor companion.</p>
            <div class="flex flex-wrap gap-5">
                <a href="#overview" class="bg-white text-gray-900 px-10 py-5 rounded-2xl font-bold shadow-2xl hover:bg-gray-100 transition-all transform hover:-translate-y-1">Shih Tzu Guide</a>
            </div>
        </div>
        <div class="md:w-1/2 mt-16 md:mt-0 flex justify-center animate__animated animate__zoomIn">
            <img src="uploads/breeds/inner/shihtzu.jpg" 
                 class="w-full max-w-lg rounded-[4rem] shadow-2xl border-[15px] border-white/20 float-anim" alt="Shih Tzu">
        </div>
    </div>
</section>
...
<div id="overview" class="max-w-6xl mx-auto -mt-24 relative z-20 px-4">
    <div class="bg-white rounded-[3rem] shadow-2xl p-10 md:p-16 border border-gray-100 reveal">
        <h2 class="text-3xl font-bold text-center mb-10 text-gray-800 italic underline decoration-[#f8bbd0]">Breed Overview</h2>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center p-6 bg-pink-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-[#e91e63] mt-3">4 - 7.5 kg</h4>
            </div>
            <div class="text-center p-6 bg-blue-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-blue-500 mt-3">20 - 28 cm</h4>
            </div>
            <div class="text-center p-6 bg-green-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-green-500 mt-3">10 - 18 Yrs</h4>
            </div>
...
<section class="section-spacing px-6 mt-10">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-green-700 mb-8 leading-tight italic">Small Kibble, <br>Big Nutrition</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Shih Tzus have unique "brachycephalic" jaws. They need specially shaped kibble that is easy to pick up and chew, with support for their sensitive skin.</p>
            <div class="grid grid-cols-2 gap-6">
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/shihfood.jpg" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Mini Adult Shih Tzu Food</p>
                </div>
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/shihcoat.jpg" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Omega Skin & Coat Chews</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/shihnut.jpg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Shih Tzu Nutrition">
        </div>
    </div>
</section>
...
<section class="bg-[#FFF8E1] section-spacing px-6">
    <div class="max-w-7xl mx-auto text-center mb-16 reveal">
        ...
        <p class="text-xl text-orange-700">The luxurious Shih Tzu coat requires daily care to prevent matting.</p>
    </div>
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-orange-400 product-card">
            <img src="uploads/breeds/inner/Tear.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Tear Stain Remover</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-blue-400 product-card">
            <img src="uploads/breeds/inner/shihbrush.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Slicker Brush</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-pink-400 product-card">
            <img src="uploads/breeds/inner/shihknot.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Top Knot Accessories</h3>
...
<section class="bg-[#FFF8E1] section-spacing px-6">
    <div class="max-w-7xl mx-auto text-center mb-16 reveal">
        <h2 class="text-5xl font-bold text-orange-900 mb-6 italic underline decoration-orange-300">Grooming Masterclass</h2>
        <p class="text-xl text-orange-700">Maintenance for that iconic Golden coat.</p>
    </div>
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-orange-400 product-card">
            <img src="uploads/breeds/inner/shihsham.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Anti-Tangle Shampoo</h3>
            <button class="px-8 py-3 bg-orange-500 text-white rounded-xl font-bold mt-4">Shop Now</button>
        </div>
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-blue-400 product-card">
            <img src="uploads/breeds/inner/shihb.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Professional Brush</h3>
            <button class="px-8 py-3 bg-blue-500 text-white rounded-xl font-bold mt-4">Shop Now</button>
        </div>
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-pink-400 product-card">
            <img src="uploads/breeds/inner/shihnail.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Nail Care Kit</h3>
            <button class="px-8 py-3 bg-pink-500 text-white rounded-xl font-bold mt-4">Shop Now</button>
        </div>
    </div>
</section>
...
<section class="section-spacing px-6 bg-white">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/shih.jpg" class="rounded-[4rem] shadow-2xl border-b-[20px] border-pink-200" alt="Training">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-pink-800 mb-8 italic">Quick learners & eager to please</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">ShihTzu are known for their high intelligence. Use <?php echo $brand; ?>'s reward-based training gear to build an unbreakable bond.</p>
            <div class="space-y-4">
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🥎</span>
                    <span class="text-lg font-bold text-pink-900">Interactive Fetch & Reward Toys</span>
                </div>
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🐕</span>
                    <span class="text-lg font-bold text-pink-900">Soft-Lined No-Pull Harnesses</span>
                </div>
            </div>
        </div>
    </div>
...
<section class="bg-purple-50 section-spacing px-6">
    <div class="max-w-5xl mx-auto flex flex-col items-center text-center reveal">
        ...
        <div class="bg-white p-12 rounded-[4rem] shadow-2xl flex flex-col md:flex-row gap-12 items-center">
            <img src="uploads/breeds/inner/spuppy.jfif" class="w-64 h-64 rounded-full object-cover border-8 border-purple-100">
            <div class="text-left">
...
<section class="section-spacing px-6 bg-[#E3F2FD]">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        <div class="md:w-1/2 reveal"> 
            <img src="uploads/breeds/inner/shihdental.jpg" 
                 class="w-full h-auto rounded-[3rem] shadow-2xl transform hover:scale-105 transition-transform duration-500" 
                 alt="Shih Tzu Health Care">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-3xl lg:text-4xl font-bold text-blue-800 mb-10 italic leading-tight">Regular care for a happy ShihTzu</h2>
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    ...
                    <div>
                        <h4 class="font-bold text-1xl text-gray-800">Dental Health</h4>
                        <p class="text-gray-500 text-lg">Small breeds are prone to tartar buildup; professional cleaning is vital.</p>
                    </div>
                </div>
                <div class="bg-blue-100 p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    <div class="bg-white p-5 rounded-full text-4xl shadow-inner">👀</div>
                    <div>
                        <h4 class="font-bold text-2xl text-gray-800">Eye Hygiene</h4>
                        <p class="text-gray-500 text-lg">Daily eye wiping prevents irritation from their long hair.</p>
                    </div>
                </div>
            </div>
        </div>
