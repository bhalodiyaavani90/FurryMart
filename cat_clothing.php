...
// 2. MASTER SYNC QUERY (Products + Variants Joined) - ONLY CLOTHING SUBCATEGORY FOR CATS
...
<style>
    ...
    .hero-glimmer { position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(rgba(15,28,63,0.7), rgba(15,28,63,0.7)), url('uploads/productpageHero/catclothhero.jpg'); background-size: cover; background-position: center; animation: slowReflect 20s infinite alternate; z-index: -1; }
...
<div class="catalog-viewport">
    <aside class="sidebar-filters">
        ...
        <div class="filter-group">
            ...
            <a href="cat_clothing.php" class="st-link <?php if(!$current_stage) echo 'active'; ?>">All Stages</a>
            <a href="?stage=Kitten" class="st-link <?php if($current_stage=='Kitten') echo 'active'; ?>">Kitten</a>
            <a href="?stage=Adult" class="st-link <?php if($current_stage=='Adult Cat') echo 'active'; ?>">Adult Cat</a>
            <a href="?stage=Senior" class="st-link <?php if($current_stage=='Senior Cat') echo 'active'; ?>">Senior Cat</a>
        </div>
 ...
 <main class="product-grid">
    ...
    <div class="product-card animate__animated animate__fadeInUp">
        ...
        <div onclick='startIntelligenceLoading(<?php echo htmlspecialchars(json_encode($p), ENT_QUOTES, "UTF-8"); ?>)'>
            <div class="img-box">
        ...
        <button class="btn-action" onclick="addToCart(<?php echo $p['variant_id']; ?>, '<?php echo addslashes($p['name']); ?>', '<?php echo $p['base_image']; ?>', <?php echo $p['price']; ?>, '<?php echo $p['size']; ?>')">ADD TO BAG</button>
