...
<section class="relative bg-[#FFB84D] pt-19 pb-40 px-6 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div class="md:w-1/2 animate__animated animate__fadeInLeft">
            ...
            <p class="text-2xl text-white/90 mb-10 leading-relaxed max-w-xl">Confident, courageous, and smart. Discover why the GSD is the world's leading police, guard, and family companion.</p>
            <div class="flex flex-wrap gap-5">
                <a href="#overview" class="bg-white text-gray-900 px-10 py-5 rounded-2xl font-bold shadow-2xl hover:bg-gray-100 transition-all transform hover:-translate-y-1">GSD Guide</a>
            </div>
        </div>
        <div class="md:w-1/2 mt-16 md:mt-0 flex justify-center animate__animated animate__zoomIn">
            <img src="uploads/breeds/inner/germansheperd.jpg" 
                 class="w-full max-w-lg rounded-[4rem] shadow-2xl border-[15px] border-white/20 float-anim" alt="German Shepherd">
        </div>
    </div>
</section>
    ...
    <div class="bg-white rounded-[3rem] shadow-2xl p-10 md:p-16 border border-gray-100 reveal">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center p-6 bg-orange-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-[#FFB84D] mt-3">22 - 40 kg</h4>
            </div>
            <div class="text-center p-6 bg-blue-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-blue-500 mt-3">55 - 65 cm</h4>
            </div>
            <div class="text-center p-6 bg-green-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-green-500 mt-3">7 - 10 Yrs</h4>
            </div>
            <div class="text-center p-6 bg-purple-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-purple-500 mt-3">Herding</h4>
            </div>
        </div>
    </div>
</div>
...
<section class="section-spacing px-6 mt-10">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            ...
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Shepherds need high-quality protein and glucosamine for joint health. We offer specialized <?php echo $brand; ?> formulas for their athletic life stages.</p>
            <div class="grid grid-cols-2 gap-6">
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/germanfood.jfif" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">GSD Adult Power Care</p>
                </div>
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/hipjoitgds.jfif" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Hip & Joint Supplements</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/germannutri.jpg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Nutrition">
        </div>
    </div>
</section>
...
<section class="bg-[#FFF8E1] section-spacing px-6">
    <div class="max-w-7xl mx-auto text-center mb-16 reveal">
        ...
        <p class="text-xl text-orange-700">Maintenance for that iconic double coat.</p>
    </div>
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-orange-400 product-card">
            <img src="uploads/breeds/inner/deepshampoo1.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Deep Clean Shampoo</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-blue-400 product-card">
            <img src="uploads/breeds/inner/undercoatrake.jpg" class="h-34 mx-auto mb-6">
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-pink-400 product-card">
            <img src="uploads/breeds/inner/gdsnail.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Professional Paw Kit</h3>
...
<section class="section-spacing px-6 bg-white">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/gds.jpg" class="rounded-[4rem] shadow-2xl border-b-[20px] border-pink-200" alt="Training">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-pink-800 mb-8 italic">Master learners & eager to serve</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Shepherds are famous for their intelligence. Use <?php echo $brand; ?>'s tactical training gear to build focus and an elite bond.</p>
            <div class="space-y-4">
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🛡️</span>
                    <span class="text-lg font-bold text-pink-900">Tactical Reward & Agility Toys</span>
                </div>
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🐕</span>
                    <span class="text-lg font-bold text-pink-900">Heavy-Duty K9 Harnesses</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr class="hover:bg-green-50/50 transition-colors">
                            ...
                            <td class="px-6 py-5 text-gray-600 text-sm">3–5 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">3–4</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Controlled growth formula for healthy joints</td>
                        </tr>
                        <tr class="hover:bg-green-50/50 transition-colors">
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Transition slowly to adult athletic diet</td>
                        </tr>
                        <tr class="hover:bg-green-50/50 transition-colors">
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5 text-gray-600 text-sm">5–7 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">2</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">High protein to fuel active muscle maintenance</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<section class="bg-purple-50 section-spacing px-6">
    <div class="max-w-5xl mx-auto flex flex-col items-center text-center reveal">
        ...
        <div class="bg-white p-12 rounded-[4rem] shadow-2xl flex flex-col md:flex-row gap-12 items-center">
            <img src="uploads/breeds/inner/gdspuppy.jpg" class="w-64 h-64 rounded-full object-cover border-8 border-purple-100">
            <div class="text-left">
                <h3 class="text-2xl font-bold mb-4">The <?php echo $brand; ?> GSD Kit</h3>
                <ul class="text-gray-600 space-y-3 mb-8">
                    <li>✓ Tactical chew toys for heavy chewers</li>
                    <li>✓ High-protein large-breed growth formulas</li>
                    <li>✓ Potty training pads & heavy-duty leads</li>
                </ul>
...
<section class="section-spacing px-6 bg-[#E3F2FD]">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        ...
        <div class="md:w-1/2 reveal"> 
            <img src="uploads/breeds/inner/germanvet.jpg" 
        ...
        <div class="md:w-1/2 reveal">
            ...
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    ...
                    <div>
                        <h4 class="font-bold text-1xl text-gray-800">Joint Screening</h4>
                        <p class="text-gray-500 text-lg">Hip and elbow dysplasia screenings are vital for GSD health.</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    <div class="bg-blue-100 p-5 rounded-full text-4xl shadow-inner">🐕</div>
                    <div>
                        <h4 class="font-bold text-2xl text-gray-800">Activity Level</h4>
                        <p class="text-gray-500 text-lg">Regular physical and mental workouts are key to preventing anxiety.</p>
                    </div>
                </div>
            </div>
        </div>
