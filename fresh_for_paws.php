...
// BRAND FILTER - Fresh For Paws
$brand_name = 'Fresh For Paws';
...
elseif($price_filter == '1000-2000') { $sql .= " AND v.price BETWEEN 1000 AND 2000"; }
elseif($price_filter == 'above2000') { $sql .= " AND v.price > 2000"; }
...
<div class="hero-vault animate__animated animate__fadeIn">
    ...
    <div class="animate__animated animate__zoomIn" style="text-align: center;">
        <h1><?php echo $brand_name; ?> Products</h1>
        <p style="font-weight: 800; text-transform: uppercase; letter-spacing: 4px; color: rgba(255,255,255,0.95);">Premium Quality Pet Nutrition</p>
    </div>
</div>
...
<div class="catalog-viewport">
    <aside class="sidebar-filters">
        ...
        <div class="filter-group">
            ...
            <a href="fresh_for_paws.php" class="st-link <?php if(!$current_stage) echo 'active'; ?>">All Stages</a>  
    ...
    <main class="product-grid">
        ...
        <div style="grid-column: 1/-1; text-align: center; padding: 60px 20px;">
            ...
            <p style="color: var(--gray);">Try adjusting your filters to see more products</p>
        </div>
        <?php endif; ?>
    </main>
</div>
