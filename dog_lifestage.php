...
$brand_res = mysqli_query($conn, "SELECT DISTINCT brand_name FROM products WHERE is_available = 1 AND life_stage != '' AND main_cat_id = 4 ORDER BY brand_name ASC");
...
$sql = "SELECT p.*, v.price, v.mrp, v.weight_size, v.stock_qty, v.id as variant_id 
        ...
        WHERE p.is_available = 1 AND p.main_cat_id = 4";
...
<div class="catalog-viewport">
    <aside class="sidebar-filters">
        ...
        <div class="filter-group">
            ...
            <a href="dog_lifestage.php" class="st-link <?php if(!$current_stage) echo 'active'; ?>">All Stages</a>
    ...
    <main class="product-grid">
        ...
        <div class="product-card animate__animated animate__fadeInUp">
            <!--<div class="diet-mark < echo ($p['veg_type'] == 'Veg') ? 'veg' : 'nonveg'; ?>"></div>-->
