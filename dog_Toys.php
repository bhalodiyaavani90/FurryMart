...
$brand_res = mysqli_query($conn, "SELECT brand_name FROM brands WHERE category = 'Accessories' AND status = 'active' ORDER BY brand_name ASC");

// 3. MASTER SYNC QUERY (Products + Variants Joined) - Filter for Toys
$sql = "SELECT p.*, v.price, v.mrp, v.weight_size, v.stock_qty, v.id as variant_id 
        ...
        WHERE p.is_available = 1 AND p.main_cat_id = 4 AND p.sub_cat_id = 4";
...
<style>
    ...
    .hero-glimmer { position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(rgba(15,28,63,0.7), rgba(15,28,63,0.7)), url('uploads/productpageHero/dogtoyhero.jpg'); background-size: cover; background-position: center; animation: slowReflect 20s infinite alternate; z-index: -1; }
...
<div class="hero-vault animate__animated animate__fadeIn">
    ...
    <div class="animate__animated animate__zoomIn" style="text-align: center;">
        <h1>Dog Toys Hub</h1>
        <p style="font-weight: 800; text-transform: uppercase; letter-spacing: 4px; color: rgba(255,255,255,0.95);">Fun, Interactive & Durable Playtime</p>
    </div>
</div>
...
<div class="catalog-viewport">
    <aside class="sidebar-filters">
        ...
        <div class="filter-group">
            ...
            <a href="dog_Toys.php" class="st-link <?php if(!$current_stage) echo 'active'; ?>">All Stages</a>
