...
<section class="relative bg-[#FFB84D] pt-19 pb-40 px-6 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div class="md:w-1/2 animate__animated animate__fadeInLeft">
            ...
            <p class="text-2xl text-white/90 mb-10 leading-relaxed max-w-xl">Lively, bold, and incredibly fluffy. Discover why the Pomeranian is the ultimate tiny companion with a giant personality.</p>
            <div class="flex flex-wrap gap-5">
                <a href="#overview" class="bg-white text-gray-900 px-10 py-5 rounded-2xl font-bold shadow-2xl hover:bg-gray-100 transition-all transform hover:-translate-y-1">Pom Guide</a>
            </div>
        </div>
        <div class="md:w-1/2 mt-16 md:mt-0 flex justify-center animate__animated animate__zoomIn">
            <img src="uploads/breeds/inner/pomeriahero.jpg" 
                 class="w-full max-w-lg rounded-[4rem] shadow-2xl border-[15px] border-white/20 float-anim" alt="Pomeranian">
        </div>
    </div>
</section>
    ...
    <div class="bg-white rounded-[3rem] shadow-2xl p-10 md:p-16 border border-gray-100 reveal">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div class="text-center p-6 bg-blue-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-blue-500 mt-3">15 - 18 cm</h4>
            </div>
...
<section class="section-spacing px-6 mt-10">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-green-700 mb-8 leading-tight italic">Small Bites, <br>Vibrant Energy</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Pomeranians have high metabolisms. They need extra-small, calorie-dense kibble rich in Omega fatty acids to support their majestic double coat and active spirit.</p>
            <div class="grid grid-cols-2 gap-6">
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/pkibble.jpg" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Mini Adult Coat Care</p>
                </div>
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/pchew.jpg" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Omega-3 Skin Chews</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/pomeriannutri.jpg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Pomeranian Nutrition">
        </div>
    </div>
</section>
...
<section class="section-spacing px-6 bg-white">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/pomtrain.jpg" class="rounded-[4rem] shadow-2xl border-b-[20px] border-pink-200" alt="Training">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-pink-800 mb-8 italic">Quick learners & highly alert</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Pomeranians are very intelligent but can be vocal. Use <?php echo $brand; ?>'s positive reward toys to channel their focus into learning tricks and quiet behavior.</p>
            <div class="space-y-4">
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🥎</span>
                    <span class="text-lg font-bold text-pink-900">Bite-Sized Plush Squeakers</span>
                </div>
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🐕</span>
                    <span class="text-lg font-bold text-pink-900">Step-In Comfort Harnesses</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr class="hover:bg-green-50/50 transition-colors">
                            ...
                            <td class="px-6 py-5 text-gray-600 text-sm">1/4 - 1/2 cup food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">3–4</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Prevents hypoglycemia in tiny pups</td>
                        </tr>
                        <tr class="hover:bg-green-50/50 transition-colors">
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5 text-gray-600 text-sm">1/2 - 3/4 cup food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">2–3</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Slowly transition to adult coat formula</td>
                        </tr>
                        <tr class="hover:bg-green-50/50 transition-colors">
                            <td class="px-6 py-5">
                                <span class="block font-bold text-gray-800">Adult</span>
                                <span class="text-[11px] text-green-600 font-bold uppercase">1–10 Years</span>
                            </td>
                            <td class="px-6 py-5 text-gray-600 text-sm">3/4 - 1 cup food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">2</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Monitor weight to avoid knee stress</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<section class="bg-purple-50 section-spacing px-6">
    <div class="max-w-5xl mx-auto flex flex-col items-center text-center reveal">
        ...
        <div class="bg-white p-12 rounded-[4rem] shadow-2xl flex flex-col md:flex-row gap-12 items-center">
            <img src="uploads/breeds/inner/BABYPOM.jpg" class="w-64 h-64 rounded-full object-cover border-8 border-purple-100">
            <div class="text-left">
                <h3 class="text-2xl font-bold mb-4">The <?php echo $brand; ?> Pom Kit</h3>
                <ul class="text-gray-600 space-y-3 mb-8">
                    <li>✓ Tiny dental chews for small jaws</li>
                    <li>✓ High-protein puppy growth formulas</li>
                    <li>✓ Warming beds for small body heat</li>
                </ul>
...
<section class="section-spacing px-6 bg-[#E3F2FD]">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        ...
        <div class="md:w-1/2 reveal"> 
            <img src="uploads/breeds/inner/pomhealth.jpg" 
            ...
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-lg">Toy breeds are prone to tartar; daily brushing is non-negotiable.</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    <div class="bg-blue-100 p-5 rounded-full text-4xl shadow-inner">🦵</div>
                    <div>
                        <h4 class="font-bold text-2xl text-gray-800">Joint Wellness</h4>
                        <p class="text-gray-500 text-lg">Monitor for luxating patella (knee issues) common in Poms.</p>
                    </div>
                </div>
            </div>
        </div>
