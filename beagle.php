...
<section class="relative bg-[#FFB84D] pt-19 pb-40 px-6 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div class="md:w-1/2 animate__animated animate__fadeInLeft">
            ...
            <p class="text-2xl text-white/90 mb-10 leading-relaxed max-w-xl">Curious, merry, and energetic explorers. Discover why the Beagle is the ultimate companion for active families.</p>
            <div class="flex flex-wrap gap-5">
                <a href="#overview" class="bg-white text-gray-900 px-10 py-5 rounded-2xl font-bold shadow-2xl hover:bg-gray-100 transition-all transform hover:-translate-y-1">Beagle Guide</a>
            </div>
        </div>
        <div class="md:w-1/2 mt-16 md:mt-0 flex justify-center animate__animated animate__zoomIn">
            <img src="uploads/breeds/inner/beagle.jpg" 
                  class="w-full max-w-lg rounded-[4rem] shadow-2xl border-[15px] border-white/20 float-anim" alt="Beagle">
        </div>
    </div>
</section>
    ...
    <div class="bg-white rounded-[3rem] shadow-2xl p-10 md:p-16 border border-gray-100 reveal">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center p-6 bg-orange-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-[#FFB84D] mt-3">9 - 14 kg</h4>
            </div>
            <div class="text-center p-6 bg-blue-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-blue-500 mt-3">33 - 41 cm</h4>
            </div>
            ...
            <div class="text-center p-6 bg-purple-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-purple-500 mt-3">Hound</h4>
            </div>
        </div>
    </div>
</div>
...
<section class="section-spacing px-6 mt-10">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            ...
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Beagles have a famous appetite! We provide portion-controlled <?php echo $brand; ?> formulas rich in fiber to keep your hound fit and healthy.</p>
            <div class="grid grid-cols-2 gap-6">
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/bkibble.jpg" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Beagle Adult Kibble</p>
                </div>
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/bdibis.jpg" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Digestive Support Biscuits</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/braglenutri.jpg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Nutrition">
        </div>
    </div>
</section>
...
<section class="bg-[#FFF8E1] section-spacing px-6">
    <div class="max-w-7xl mx-auto text-center mb-16 reveal">
        ...
        <p class="text-xl text-orange-700">Simple maintenance for a happy hound's coat.</p>
    </div>
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-orange-400 product-card">
            <img src="uploads/breeds/inner/bshampoo.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Fresh Scent Shampoo</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-blue-400 product-card">
            <img src="uploads/breeds/inner/beaglerubrush.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Rubber Curry Brush</h3>
            <a href="dog_Grooming.php" class="inline-block px-8 py-3 bg-blue-500 text-white rounded-xl font-bold mt-4 inline-block">Shop Now</a>
        </div>
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-pink-400 product-card">
            <img src="uploads/breeds/inner/beagleearcare.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Ear Care Solution</h3>
            <a href="dog_Grooming.php" class="inline-block px-8 py-3 bg-pink-500 text-white rounded-xl font-bold mt-4">Shop Now</a>
        </div>
    </div>
</section>
...
<section class="section-spacing px-6 bg-white">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/beagletrain.jpg" class="rounded-[4rem] shadow-2xl border-b-[20px] border-pink-200" alt="Training">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-pink-800 mb-8 italic">Training should be consistent & fun</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Beagles are guided by their noses! Use <?php echo $brand; ?>'s scent-based training toys to channel their natural curiosity and energy positively.</p>
            <div class="space-y-4">
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🦴</span>
                    <span class="text-lg font-bold text-pink-900">Scent-Marker Reward Toys</span>
                </div>
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🐾</span>
                    <span class="text-lg font-bold text-pink-900">Long Tracking Leads</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr class="hover:bg-green-50/50 transition-colors">
                            ...
                            <td class="px-6 py-5 text-gray-600 text-sm">1 - 2 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">3–4</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Use small-breed puppy formula for growth</td>
                        </tr>
                        <tr class="hover:bg-green-50/50 transition-colors">
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5 text-gray-600 text-sm">1.5 - 2.5 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">2–3</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Monitor weight closely during transition</td>
                        </tr>
                        <tr class="hover:bg-green-50/50 transition-colors">
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5 text-gray-600 text-sm">1.5 - 2 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">2</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">High-protein, low-fat maintenance</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<section class="bg-purple-50 section-spacing px-6">
    <div class="max-w-5xl mx-auto flex flex-col items-center text-center reveal">
        ...
        <div class="bg-white p-12 rounded-[4rem] shadow-2xl flex flex-col md:flex-row gap-12 items-center">
            <img src="uploads/breeds/inner/beaglepuppy.jpg" class="w-64 h-64 rounded-full object-cover border-8 border-purple-100">
            <div class="text-left">
                <h3 class="text-2xl font-bold mb-4">The <?php echo $brand; ?> Beagle Kit</h3>
                <ul class="text-gray-600 space-y-3 mb-8">
                    <li>✓ Scent-work discovery toys for mental stimulation</li>
                    <li>✓ High-fiber puppy growth formulas</li>
                    <li>✓ Secure harnesses with ID tag slots</li>
                </ul>
        ...
        <div class="md:w-1/2 reveal">
            ...
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    ...
                    <div>
                        <h4 class="font-bold text-1xl text-gray-800">Ear Hygiene</h4>
                        <p class="text-gray-500 text-lg">Long Beagle ears need weekly cleaning to avoid yeast growth.</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    ...
                    <div>
                        <h4 class="font-bold text-2xl text-gray-800">Weight Monitoring</h4>
                        <p class="text-gray-500 text-lg">Beagles are food-motivated; keep them slim to protect their backs.</p>
                    </div>
                </div>
            </div>
        </div>
