...
<section class="relative bg-[#FFB84D] pt-19 pb-40 px-6 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div class="md:w-1/2 animate__animated animate__fadeInLeft">
            ...
            <p class="text-2xl text-white/90 mb-10 leading-relaxed max-w-xl">Playful, patient, and protective. Discover why the Boxer is the ultimate family guardian and energetic playmate.</p>
            <div class="flex flex-wrap gap-5">
                <a href="#overview" class="bg-white text-gray-900 px-10 py-5 rounded-2xl font-bold shadow-2xl hover:bg-gray-100 transition-all transform hover:-translate-y-1">Boxer Guide</a>
            </div>
        </div>
        <div class="md:w-1/2 mt-16 md:mt-0 flex justify-center animate__animated animate__zoomIn">
            <img src="uploads/breeds/inner/boxer.jpg" 
                 class="w-full max-w-lg rounded-[4rem] shadow-2xl border-[15px] border-white/20 float-anim" alt="Boxer Dog">
        </div>
    </div>
</section>
    ...
    <div class="bg-white rounded-[3rem] shadow-2xl p-10 md:p-16 border border-gray-100 reveal">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center p-6 bg-orange-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-[#FFB84D] mt-3">25 - 32 kg</h4>
            </div>
            <div class="text-center p-6 bg-blue-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-blue-500 mt-3">53 - 63 cm</h4>
            </div>
            ...
            <div class="text-center p-6 bg-purple-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-purple-500 mt-3">Working</h4>
            </div>
        </div>
    </div>
</div>
...
<section class="section-spacing px-6 mt-10">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            ...
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Boxers are high-energy athletes prone to heart issues. They need L-carnitine and high-quality protein to maintain lean muscle and a healthy heart.</p>
            <div class="grid grid-cols-2 gap-6">
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/boxeradult.jfif" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Boxer Adult Muscle Care</p>
                </div>
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/boxerbis.jfif" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Heart-Healthy Biscuits</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/boxernutrition1.jpg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Boxer Nutrition">
        </div>
    </div>
</section>
...
<section class="bg-[#FFF8E1] section-spacing px-6">
    <div class="max-w-7xl mx-auto text-center mb-16 reveal">
        ...
        <p class="text-xl text-orange-700">Low-maintenance coat but high-maintenance wrinkles! Keep your Boxer fresh with <?php echo $brand; ?> gear.</p>
    </div>
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-orange-400 product-card">
            <img src="uploads/breeds/inner/boxershampoo.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Sensitive Skin Shampoo</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-blue-400 product-card">
            <img src="uploads/breeds/inner/rubberboxer.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Rubber Curry Brush</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-pink-400 product-card">
            <img src="uploads/breeds/inner/boxerkit.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Wrinkle Care Kit</h3>
...
<section class="section-spacing px-6 bg-white">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/boxertrain1.jpg" class="rounded-[4rem] shadow-2xl border-b-[20px] border-pink-200" alt="Boxer Training">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-pink-800 mb-8 italic">Smart but stubborn clowns</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Boxers learn quickly but have a short attention span. Use <?php echo $brand; ?>'s interactive reward toys to keep training sessions fun and productive.</p>
            <div class="space-y-4">
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🎾</span>
                    <span class="text-lg font-bold text-pink-900">Heavy-Duty Fetch Launchers</span>
                </div>
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🐕</span>
                    <span class="text-lg font-bold text-pink-900">Anti-Pull Front Clip Harnesses</span>
                </div>
            </div>
        </div>
    </div>
...
<section class="section-spacing px-6 py-16 bg-[#fafafa]">
    <div class="feeding-section-wrapper reveal-content">
        <div class="mb-10">
            <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 mb-2 italic text-center">
            ...
            <p class="text-gray-500 font-medium text-center">
                Standard nutrition schedule for your active <?php echo $breed; ?>.
            </p>
        </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-50 text-gray-700">
                        <tr class="hover:bg-green-50/50 transition-colors">
                            ...
                            <td class="px-6 py-5">2.5 – 4 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">3–4</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Large-breed puppy formula for controlled growth</td>
                        </tr>
                        <tr class="hover:bg-green-50/50 transition-colors">
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5">3.5 – 5 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">2–3</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Transition to adult formula around 12-14 months</td>
                        </tr>
                        <tr class="hover:bg-green-50/50 transition-colors">
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5">3 – 4.5 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">2</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">High-protein diet to fuel intense energy levels</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="mt-8 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
            ...
            <p class="text-gray-600 text-sm">
                <strong class="text-gray-900">Note:</strong> Boxers are prone to "Bloat." Use elevated slow-feeder bowls and avoid exercise after meals.
            </p>
        </div>
    </div>
</section>
...
<section class="bg-purple-50 section-spacing px-6">
    <div class="max-w-5xl mx-auto flex flex-col items-center text-center reveal">
        ...
        <div class="bg-white p-12 rounded-[4rem] shadow-2xl flex flex-col md:flex-row gap-12 items-center">
            <img src="uploads/breeds/inner/boxerpup.jpg" class="w-64 h-64 rounded-full object-cover border-8 border-purple-100">
            <div class="text-left">
                <h3 class="text-2xl font-bold mb-4">The <?php echo $brand; ?> Boxer Kit</h3>
                <ul class="text-gray-600 space-y-3 mb-8">
                    <li>✓ Indestructible chew toys for powerful jaws</li>
                    <li>✓ High-protein large-breed growth formulas</li>
                    <li>✓ Wrinkle cleaning wipes & dental care chews</li>
                </ul>
...
<section class="section-spacing px-6 bg-[#E3F2FD]">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        <div class="md:w-1/2 reveal"> 
            <img src="uploads/breeds/inner/boxerhealth.jpg" class="w-full h-auto rounded-[3rem] shadow-2xl transform hover:scale-105 transition-transform duration-500" alt="Boxer Health Care">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-3xl lg:text-4xl font-bold text-blue-800 mb-10 italic leading-tight">Regular care for a happy athlete</h2>
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    ...
                    <div>
                        <h4 class="font-bold text-xl text-gray-800">Cardiac Monitoring</h4>
                        <p class="text-gray-500 text-lg">Regular heart checkups are vital for this athletic breed.</p>
                    </div>
                </div>
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    <div class="bg-blue-100 p-5 rounded-full text-4xl shadow-inner">🧴</div>
                    <div>
                        <h4 class="font-bold text-2xl text-gray-800">Wrinkle Hygiene</h4>
                        <p class="text-gray-500 text-lg">Keep facial folds clean and dry to prevent skin infections.</p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function toggleBreedCat(category, buttonElement) {
        ...
        document.querySelectorAll('.breed-container').forEach(container => container.classList.remove('active'));
