...
<section class="relative bg-[#FFB84D] pt-19 pb-40 px-6 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div class="md:w-1/2 animate__animated animate__fadeInLeft">
            ...
            <p class="text-2xl text-white/90 mb-10 leading-relaxed max-w-xl">Gentle, merry, and full of energy. Discover why the Cocker is India's favorite affectionate family companion.</p>
            <div class="flex flex-wrap gap-5">
                <a href="#overview" class="bg-white text-gray-900 px-10 py-5 rounded-2xl font-bold shadow-2xl hover:bg-gray-100 transition-all transform hover:-translate-y-1">Cocker Guide</a>
            </div>
        </div>
        <div class="md:w-1/2 mt-16 md:mt-0 flex justify-center animate__animated animate__zoomIn">
            <img src="uploads/breeds/inner/the cockerspanial.jpg" 
                 class="w-full max-w-lg rounded-[4rem] shadow-2xl border-[15px] border-white/20 float-anim" alt="Cocker Spaniel">
        </div>
    </div>
</section>
    ...
    <div class="bg-white rounded-[3rem] shadow-2xl p-10 md:p-16 border border-gray-100 reveal">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center p-6 bg-orange-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-[#FFB84D] mt-3">11 - 15 kg</h4>
            </div>
            <div class="text-center p-6 bg-blue-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-blue-500 mt-3">36 - 41 cm</h4>
            </div>
            <div class="text-center p-6 bg-green-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-green-500 mt-3">12 - 14 Yrs</h4>
            </div>
...
<section class="section-spacing px-6 mt-10">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            ...
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Cocker Spaniels need high-quality protein for their silky coats and balanced calories to avoid obesity. We offer specialized <?php echo $brand; ?> formulas for every life stage.</p>
            <div class="grid grid-cols-2 gap-6">
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/cockerkibble.jpg" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Adult Cocker Kibble</p>
                </div>
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/cockerbis.jpg" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Skin & Coat Biscuits</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/cockerfood1.jpg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Nutrition">
        </div>
    </div>
</section>
...
<section class="bg-[#FFF8E1] section-spacing px-6">
    <div class="max-w-7xl mx-auto text-center mb-16 reveal">
        ...
        <p class="text-xl text-orange-700">Maintenance for that iconic silky Spaniel coat.</p>
    </div>
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-orange-400 product-card">
            <img src="uploads/breeds/inner/crockershampoo.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Silk Shine Shampoo</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-blue-400 product-card">
            ...
            <h3 class="text-2xl font-bold mb-3">Professional Slicker</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-pink-400 product-card">
            <img src="uploads/breeds/inner/spanialdental.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Spaniel Dental Kit</h3>
...
<section class="section-spacing px-6 bg-white">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/cockertrain.jpg" class="rounded-[4rem] shadow-2xl border-b-[20px] border-pink-200" alt="Training">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-pink-800 mb-8 italic">Quick learners & full of energy</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Cocker Spaniels are sensitive and eager to please. Use <?php echo $brand; ?>'s reward-based training gear to build a gentle, consistent bond during play.</p>
            <div class="space-y-4">
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🥎</span>
                    <span class="text-lg font-bold text-pink-900">Interactive Fetch & Squeaky Toys</span>
                </div>
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🐕</span>
                    <span class="text-lg font-bold text-pink-900">Adjustable Padded Harnesses</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr class="hover:bg-green-50/50 transition-colors">
                            ...
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Use small-medium breed puppy formula</td>
                        </tr>
                        <tr class="hover:bg-green-50/50 transition-colors">
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5 text-gray-600 text-sm">2 - 2.5 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">2–3</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Gradually transition to adult formula</td>
                        </tr>
                        <tr class="hover:bg-green-50/50 transition-colors">
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Monitor weight strictly for spaniels</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<section class="bg-purple-50 section-spacing px-6">
    <div class="max-w-5xl mx-auto flex flex-col items-center text-center reveal">
        ...
        <div class="bg-white p-12 rounded-[4rem] shadow-2xl flex flex-col md:flex-row gap-12 items-center">
            <img src="uploads/breeds/inner/cockerpup.jpg" class="w-64 h-64 rounded-full object-cover border-8 border-purple-100">
            <div class="text-left">
                <h3 class="text-2xl font-bold mb-4">The <?php echo $brand; ?> Cocker Kit</h3>
                <ul class="text-gray-600 space-y-3 mb-8">
                    <li>✓ Deep-dish bowls for Spaniel ears</li>
                    <li>✓ High-protein puppy growth formulas</li>
                    <li>✓ Professional-grade grooming brushes</li>
                </ul>
...
<section class="section-spacing px-6 bg-[#E3F2FD]">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        ...
        <div class="md:w-1/2 reveal"> 
            <img src="uploads/breeds/inner/cockerhealth.jpg" 
            ...
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-lg">Cocker ears are prone to infections; weekly cleaning is a must.</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    <div class="bg-blue-100 p-5 rounded-full text-4xl shadow-inner">👀</div>
                    <div>
                        <h4 class="font-bold text-2xl text-gray-800">Eye Checkups</h4>
                        <p class="text-gray-500 text-lg">Keep eyes clean to prevent cherry eye or infections common in spaniels.</p>
                    </div>
                </div>
            </div>
        </div>
