...
<style>
    :root {
        --brand-accent: #e11d48;
        --pug-theme: #FFB84D; /* Warm Pug Fawn color */
        --soft-bg: #FFFAF0;
    }
...
<section class="relative bg-[#FFB84D] pt-19 pb-40 px-6 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div class="md:w-1/2 animate__animated animate__fadeInLeft">
            ...
            <p class="text-2xl text-white/90 mb-10 leading-relaxed max-w-xl">Charming, mischievous, and affectionate. The <?php echo $breed; ?> is the ultimate big dog in a small space.</p>
        ...
        <div class="md:w-1/2 mt-16 md:mt-0 flex justify-center animate__animated animate__zoomIn">
            <img src="uploads/breeds/inner/pug.jpg" 
                 class="w-full max-w-lg rounded-[4rem] shadow-2xl border-[15px] border-white/20 float-anim" alt="Pug">
        </div>
    </div>
</section>
    ...
    <div class="bg-white rounded-[3rem] shadow-2xl p-10 md:p-16 border border-gray-100 reveal">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center p-6 bg-orange-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-[#FFB84D] mt-3">6 - 8 kg</h4>
            </div>
            <div class="text-center p-6 bg-blue-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-blue-500 mt-3">25 - 33 cm</h4>
            </div>
...
<section class="section-spacing px-6 mt-10">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-green-700 mb-8 leading-tight italic">Portion-controlled, <br>nutrient-dense diets</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Pugs love food but gain weight easily. They need calorie-conscious diets and joint-support formulas to maintain their stocky build without stress on their legs.</p>
            <div class="grid grid-cols-2 gap-6">
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/pugweight.jpg" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Adult Pug Weight Care</p>
                </div>
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/pugjoint.jpg" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Joint Support Bits</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/pugnutri.jpg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Pug Nutrition">
        </div>
    </div>
</section>
...
<section class="bg-[#FFF8E1] section-spacing px-6">
    <div class="max-w-7xl mx-auto text-center mb-16 reveal">
        ...
        <p class="text-xl text-orange-700">Don't let the short hair fool you—Pugs shed! Daily brushing and wrinkle cleaning are the secrets to a fresh Pug.</p>
    </div>
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-orange-400 product-card">
            <img src="uploads/breeds/inner/pugbalm.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Wrinkle Soothing Balm</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-blue-400 product-card">
            <img src="uploads/breeds/inner/detool.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">De-Shedding Tool</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-pink-400 product-card">
            <img src="uploads/breeds/inner/wipes.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Gentle Facial Wipes</h3>
...
<section class="section-spacing px-6 py-16 bg-[#fafafa]">
    <div class="feeding-section-wrapper reveal">
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-50 text-gray-700">
                        <tr class="hover:bg-green-50/50">
                            <td class="px-6 py-5">
                                <span class="block font-bold">Puppy</span>
                                <span class="text-[11px] text-green-600 font-bold uppercase tracking-wide">2–6 Months</span>
                            </td>
                            <td class="px-6 py-5 font-medium">1 - 1.5 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">3–4</span></td>
                            <td class="px-6 py-5 italic text-sm">Focus on high-calcium growth formulas</td>
                        </tr>
                        <tr class="hover:bg-green-50/50">
                            <td class="px-6 py-5">
                                <span class="block font-bold">Adult</span>
                                <span class="text-[11px] text-green-600 font-bold uppercase tracking-wide">1+ Years</span>
                            </td>
                            <td class="px-6 py-5 font-medium">1.5 - 2 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">2</span></td>
                            <td class="px-6 py-5 italic text-sm">Portion control is vital to prevent obesity</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="mt-8 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
            ...
            <p class="text-gray-600 text-sm"><strong>Note:</strong> Pugs are prone to "bloat." Use slow-feeder bowls to ensure they don't eat too fast.</p>
        </div>
    </div>
</section>
...
<section class="bg-purple-50 section-spacing px-6">
    <div class="max-w-5xl mx-auto flex flex-col items-center text-center reveal">
        <h2 class="text-5xl font-bold text-purple-900 mb-8 italic">New Pug Puppy? Get Setup!</h2>
        <div class="bg-white p-12 rounded-[4rem] shadow-2xl flex flex-col md:flex-row gap-12 items-center">
            <img src="uploads/breeds/inner/ppuppy.jpg" class="w-64 h-64 rounded-full object-cover border-8 border-purple-100">
            <div class="text-left">
                <h3 class="text-2xl font-bold mb-4">The <?php echo $brand; ?> Pug Starter Kit</h3>
                <ul class="text-gray-600 space-y-3 mb-8">
                    <li>✓ Gentle wrinkle cleaning solution & wipes</li>
                    <li>✓ High-protein small-breed puppy growth formulas</li>
                    <li>✓ Safe, soft-mesh harnesses for easy breathing</li>
                </ul>
...
<section class="section-spacing px-6 bg-[#E3F2FD]">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        <div class="md:w-1/2 reveal"> 
            <img src="uploads/breeds/inner/pugvet.jpg" 
                 class="w-full h-auto rounded-[3rem] shadow-2xl transform hover:scale-105 transition-transform duration-500" 
                 alt="Pug Health Care">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-3xl lg:text-4xl font-bold text-blue-800 mb-10 italic leading-tight">Vet-approved care for your Pug</h2>
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    ...
                    <div>
                        <h4 class="font-bold text-xl text-gray-800">Breathing Support</h4>
                        <p class="text-gray-500 text-lg">Watch for "Reverse Sneezing" and keep them cool in summer.</p>
                    </div>
                </div>
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    <div class="bg-blue-100 p-5 rounded-full text-4xl shadow-inner">👁️</div>
                    <div>
                        <h4 class="font-bold text-xl text-gray-800">Eye Protection</h4>
                        <p class="text-gray-500 text-lg">Pugs have prominent eyes—check daily for scratches or irritation.</p>
                    </div>
                </div>
            </div>
        </div>
