...
<style>
    ...
    /* Responsive adjustments for breed section */
...
<section class="relative bg-[#FFB84D] pt-19 pb-40 px-6 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div class="md:w-1/2 animate__animated animate__fadeInLeft">
            ...
            <p class="text-2xl text-white/90 mb-10 leading-relaxed max-w-xl">Friendly, reliable, and trustworthy. Discover why the Golden is the world's favorite family companion.</p>
            <div class="flex flex-wrap gap-5">
                <a href="#overview" class="bg-white text-gray-900 px-10 py-5 rounded-2xl font-bold shadow-2xl hover:bg-gray-100 transition-all transform hover:-translate-y-1">Breed Guide</a>
     
            </div>
        </div>
        <div class="md:w-1/2 mt-16 md:mt-0 flex justify-center animate__animated animate__zoomIn">
            <img src="uploads/breeds/inner/golden.jpeg" 
                 class="w-full max-w-lg rounded-[4rem] shadow-2xl border-[15px] border-white/20 float-anim" alt="Golden Retriever">
        </div>
    </div>
</section>
    ...
    <div class="bg-white rounded-[3rem] shadow-2xl p-10 md:p-16 border border-gray-100 reveal">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center p-6 bg-orange-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-[#FFB84D] mt-3">25 - 34 kg</h4>
            </div>
            <div class="text-center p-6 bg-blue-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-blue-500 mt-3">51 - 61 cm</h4>
            </div>
...
<section class="section-spacing px-6 mt-10">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            ...
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Goldens need high-quality protein and healthy fats for their thick coats. We offer specialized <?php echo $brand; ?> formulas for every life stage.</p>
            <div class="grid grid-cols-2 gap-6">
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/adoptgolden.png" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Adult Golden Kibble</p>
                </div>
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/shinebis.jfif" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Shiny Coat Biscuits</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="https://images.pexels.com/photos/1108099/pexels-photo-1108099.jpeg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Nutrition">
        </div>
    </div>
</section>
...
<section class="bg-[#FFF8E1] section-spacing px-6">
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-orange-400 product-card">
            <img src="uploads/breeds/inner/antitagle.jfif" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Anti-Tangle Shampoo</h3>
            <a href="dog_Grooming.php" class="inline-block px-8 py-3 bg-orange-500 text-white rounded-xl font-bold mt-4 hover:bg-orange-600 transition">Shop Now</a>
        </div>
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-blue-400 product-card">
            <img src="uploads/breeds/inner/brush.jfif" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Professional Brush</h3>
            <a href="dog_Grooming.php" class="inline-block px-8 py-3 bg-blue-500 text-white rounded-xl font-bold mt-4 hover:bg-blue-600 transition">Shop Now</a>
        </div>
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-pink-400 product-card">
            <img src="uploads/breeds/inner/nail.jfif" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Nail Care Kit</h3>
            <a href="dog_Grooming.php" class="inline-block px-8 py-3 bg-pink-500 text-white rounded-xl font-bold mt-4 hover:bg-pink-600 transition">Shop Now</a>
        </div>
    </div>
</section>
...
<section class="section-spacing px-6 bg-white">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
        <div class="md:w-1/2 reveal">
            <img src="https://images.pexels.com/photos/2253275/pexels-photo-2253275.jpeg" class="rounded-[4rem] shadow-2xl border-b-[20px] border-pink-200" alt="Training">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-pink-800 mb-8 italic">Quick learners & eager to please</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Goldens are known for their high intelligence. Use <?php echo $brand; ?>'s reward-based training gear to build an unbreakable bond.</p>
            <div class="space-y-4">
...
<section class="bg-purple-50 section-spacing px-6">
    <div class="max-w-5xl mx-auto flex flex-col items-center text-center reveal">
        ...
        <div class="bg-white p-12 rounded-[4rem] shadow-2xl flex flex-col md:flex-row gap-12 items-center">
            <img src="https://images.pexels.com/photos/1108099/pexels-photo-1108099.jpeg" class="w-64 h-64 rounded-full object-cover border-8 border-purple-100">
            <div class="text-left">
...
<section class="section-spacing px-6 bg-[#E3F2FD]">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        ...
        <div class="md:w-1/2 reveal"> 
            <img src="uploads/breeds/inner/health.jpg" 
            ...
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-lg">Goldens are prone to tartar; daily brushing is key.</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    <div class="bg-blue-100 p-5 rounded-full text-4xl shadow-inner">👂</div>
                    <div>
                        <h4 class="font-bold text-2xl text-gray-800">Ear Maintenance</h4>
                        <p class="text-gray-500 text-lg">Keep those floppy ears clean to prevent infection.</p>
                    </div>
                </div>
            </div>
        </div>
