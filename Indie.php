...
<section class="relative bg-[#FFB84D] pt-19 pb-40 px-6 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div class="md:w-1/2 animate__animated animate__fadeInLeft">
            ...
            <p class="text-2xl text-white/90 mb-10 leading-relaxed max-w-xl">Alert, active, and highly independent. Discover why Indies are the most resilient and loyal companions for Indian homes.</p>
            <div class="flex flex-wrap gap-5">
                <a href="#overview" class="bg-white text-gray-900 px-10 py-5 rounded-2xl font-bold shadow-2xl hover:bg-gray-100 transition-all transform hover:-translate-y-1">Indie Guide</a>
            </div>
        </div>
        <div class="md:w-1/2 mt-16 md:mt-0 flex justify-center animate__animated animate__zoomIn">
            <img src="uploads/breeds/inner/indidog.jpg" 
                 class="w-full max-w-lg rounded-[4rem] shadow-2xl border-[15px] border-white/20 float-anim" alt="Indie Dog">
        </div>
    </div>
</section>
    ...
    <div class="bg-white rounded-[3rem] shadow-2xl p-10 md:p-16 border border-gray-100 reveal">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center p-6 bg-orange-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-[#FFB84D] mt-3">15 - 25 kg</h4>
            </div>
            <div class="text-center p-6 bg-blue-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-blue-500 mt-3">51 - 64 cm</h4>
            </div>
            <div class="text-center p-6 bg-green-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-green-500 mt-3">13 - 16 Yrs</h4>
            </div>
            <div class="text-center p-6 bg-purple-50 rounded-3xl product-card">
                ...
                <h4 class="text-3xl font-extrabold text-purple-500 mt-3">Highly Alert</h4>
            </div>
        </div>
    </div>
</div>
...
<section class="section-spacing px-6 mt-10">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            ...
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Indies are hardy but deserve the best nutrition. They thrive on protein-rich diets that support their high energy levels and natural immunity. Explore <?php echo $brand; ?>'s Indie-specific nutrition.</p>
            <div class="grid grid-cols-2 gap-6">
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/indienutrition.jfif" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Active Adult Dog Food</p>
                </div>
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-green-500">
                    <img src="uploads/breeds/inner/bisindie.jfif" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Immunity Booster Biscuits</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/indinut.png" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Indie Nutrition">
        </div>
    </div>
</section>
...
<section class="bg-[#FFF8E1] section-spacing px-6">
    <div class="max-w-7xl mx-auto text-center mb-16 reveal">
        ...
        <p class="text-xl text-orange-700">Low maintenance but regular care helps keep their short coat shiny and skin healthy.</p>
    </div>
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-orange-400 product-card">
            <img src="uploads/breeds/inner/neemindie.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Herbal Neem Shampoo</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-blue-400 product-card">
            <img src="uploads/breeds/inner/rubber.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Rubber Grooming Glove</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-pink-400 product-card">
            <img src="uploads/breeds/inner/tickspray.jpg" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Natural Tick Spray</h3>
...
<section class="section-spacing px-6 bg-white">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/indiedogtrain.jpg" class="rounded-[4rem] shadow-2xl border-b-[20px] border-pink-200" alt="Training">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-pink-800 mb-8 italic">Positive reinforcement works best</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Indies are very intelligent and sensitive. Build trust through reward-based training to channel their energy into being the perfect guardian.</p>
            <div class="space-y-4">
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🎾</span>
                    <span class="text-lg font-bold text-pink-900">Interactive Fetch Toys</span>
                </div>
                <div class="flex items-center gap-5 p-5 bg-pink-50 rounded-2xl border-l-8 border-pink-500 product-card">
                    <span class="text-2xl">🍖</span>
                    <span class="text-lg font-bold text-pink-900">High-Value Training Treats</span>
                </div>
            </div>
        </div>
    </div>
...
<section class="section-spacing px-6 py-16 bg-[#fafafa]">
    <div class="feeding-section-wrapper reveal-content">
        <div class="mb-10 text-center">
            ...
            <p class="text-gray-500 font-medium">Standard nutrition schedule for your happy <?php echo $breed; ?>.</p>
        </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr class="hover:bg-green-50/50 transition-colors">
                            ...
                            <td class="px-6 py-5 text-gray-600 text-sm">2 - 3 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">3–4</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Rich protein for healthy muscle growth</td>
                        </tr>
                        <tr class="hover:bg-green-50/50 transition-colors">
                            <td class="px-6 py-5">
                                <span class="block font-bold text-gray-800">Adult</span>
                                <span class="text-[11px] text-green-600 font-bold uppercase">1+ Years</span>
                            </td>
                            <td class="px-6 py-5 text-gray-600 text-sm">3 - 4 cups food</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">2</span></td>
                            <td class="px-6 py-5 text-gray-500 italic text-sm">Maintain weight based on activity level</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="mt-8 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
            ...
            <p class="text-gray-600 text-sm">
                <strong class="text-gray-900">Note:</strong> Indies have high metabolism. Consult a vet at <strong class="text-green-600"><?php echo $brand; ?></strong> for a customized diet plan.
            </p>
        </div>
    </div>
</section>
...
<section class="bg-purple-50 section-spacing px-6">
    <div class="max-w-5xl mx-auto flex flex-col items-center text-center reveal">
        ...
        <div class="bg-white p-12 rounded-[4rem] shadow-2xl flex flex-col md:flex-row gap-12 items-center">
            <img src="uploads/breeds/inner/indiepuppy.jpeg" class="w-64 h-64 rounded-full object-cover border-8 border-purple-100">
            <div class="text-left">
                <h3 class="text-2xl font-bold mb-4">The <?php echo $brand; ?> Indie Kit</h3>
                <ul class="text-gray-600 space-y-3 mb-8">
                    <li>✓ High-durability toys for strong chewers</li>
                    <li>✓ Nutrient-rich puppy growth formulas</li>
                    <li>✓ Comfortable, adjustable harnesses for walks</li>
                </ul>
        ...
        <div class="md:w-1/2 reveal">
            ...
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    ...
                    <div>
                        <h4 class="font-bold text-1xl text-gray-800">Vaccination</h4>
                        <p class="text-gray-500 text-lg">Regular shots are the foundation for a long, healthy Indie life.</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-blue-500 product-card flex items-center gap-6">
                    <div class="bg-blue-100 p-5 rounded-full text-4xl shadow-inner">💊</div>
                    <div>
                        <h4 class="font-bold text-2xl text-gray-800">Deworming</h4>
                        <p class="text-gray-500 text-lg">Essential for preventing internal parasites in active dogs.</p>
                    </div>
                </div>
            </div>
        </div>
