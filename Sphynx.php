...
<style>
    :root {
        --brand-accent: #e11d48;
        --cat-theme: #fda4af; /* Peachy-pink to match Sphynx skin tones */
        --soft-bg: #fffbfb;
    }
...
<section class="relative bg-rose-200 pt-19 pb-40 px-6 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div class="md:w-1/2 animate__animated animate__fadeInLeft">
            <span class="bg-white/30 text-rose-700 px-5 py-2 rounded-full font-bold text-xs uppercase tracking-widest border border-white/40">Exotic Spotlight</span>
            <h1 class="text-6xl md:text-8xl font-extrabold text-white mt-6 mb-8 drop-shadow-lg leading-tight">The <?php echo $breed; ?></h1>
            <p class="text-2xl text-white/90 mb-10 leading-relaxed max-w-xl">Curious, high-energy, and velvety soft. Discover why the hairless Sphynx is the world's most affectionate "velcro" cat.</p>
            <div class="flex flex-wrap gap-5">
                <a href="#overview" class="bg-white text-gray-900 px-10 py-5 rounded-2xl font-bold shadow-2xl hover:bg-gray-100 transition-all transform hover:-translate-y-1">Sphynx Guide</a>
            </div>
        </div>
        <div class="md:w-1/2 mt-16 md:mt-0 flex justify-center animate__animated animate__zoomIn">
            <img src="uploads/breeds/inner/sphynx_hero.png" 
                 class="w-full max-w-lg rounded-[4rem] shadow-2xl border-[15px] border-white/20 float-anim" alt="Sphynx Cat">
        </div>
    </div>
</section>
...
<div id="overview" class="max-w-6xl mx-auto -mt-24 relative z-20 px-4">
    <div class="bg-white rounded-[3rem] shadow-2xl p-10 md:p-16 border border-gray-100 reveal">
        <h2 class="text-3xl font-bold text-center mb-10 text-gray-800 italic underline decoration-rose-300">At a Glance</h2>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center p-6 bg-rose-50 rounded-3xl product-card">
                <p class="text-gray-400 text-xs uppercase font-bold">Weight Range</p>
                <h4 class="text-3xl font-extrabold text-rose-500 mt-3">3.5 - 5.5 kg</h4>
            </div>
            <div class="text-center p-6 bg-orange-50 rounded-3xl product-card">
                <p class="text-gray-400 text-xs uppercase font-bold">Body Temp</p>
                <h4 class="text-3xl font-extrabold text-orange-500 mt-3">High Metabolic</h4>
            </div>
            ...
            <div class="text-center p-6 bg-purple-50 rounded-3xl product-card">
                <p class="text-gray-400 text-xs uppercase font-bold">Social Need</p>
...
<section class="section-spacing px-6 mt-10">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-emerald-700 mb-8 leading-tight italic">Sphynx cats have a <br>supercharged metabolism</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Because they have no fur to trap body heat, Sphynx cats burn calories faster to stay warm. They require high-protein, high-fat diets with complex carbohydrates to maintain their core temperature. Explore <?php echo $brand; ?>'s metabolic-support nutrition.</p>
            <div class="grid grid-cols-2 gap-6">
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-emerald-500">
                    <img src="uploads/breeds/inner/high_calorie_kibble.png" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Sphynx Energy Plus</p>
                </div>
                <div class="product-card bg-white p-6 rounded-3xl shadow-lg text-center border-b-8 border-emerald-500">
                    <img src="uploads/breeds/inner/omega_oil.png" class="h-32 mx-auto mb-4 object-contain">
                    <p class="font-bold">Skin Hydration Oil</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/sphynx_nutrition.jpg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Sphynx Nutrition">
        </div>
    </div>
</section>
...
<section class="bg-[#FFF8E1] section-spacing px-6">
    <div class="max-w-7xl mx-auto text-center mb-16 reveal">
        <h2 class="text-5xl font-bold text-orange-900 mb-6 italic underline decoration-orange-300">Skin Maintenance Masterclass</h2>
        <p class="text-xl text-orange-700">No fur means skin oils accumulate. Weekly sponge baths are the key to a healthy Sphynx skin.</p>
    </div>
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-orange-400 product-card">
            <img src="uploads/breeds/inner/cat_skin_wash.png" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Medicated Skin Wash</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-blue-400 product-card">
            <img src="uploads/breeds/inner/ear_cleaner_sphynx.png" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Oil Removal Ear Gel</h3>
        ...
        <div class="reveal bg-white p-10 rounded-[3rem] shadow-xl text-center border-t-8 border-pink-400 product-card">
            <img src="uploads/breeds/inner/paw_balm.png" class="h-34 mx-auto mb-6">
            <h3 class="text-2xl font-bold mb-3">Protective Paw Balm</h3>
...
<section class="section-spacing px-6 bg-white">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/sphynx_sweater.jpg" class="rounded-[4rem] shadow-2xl border-b-[20px] border-rose-200" alt="Sphynx in Sweater">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-rose-800 mb-8 italic">Body heat is their priority</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">Sphynx cats are "heat seekers." They will cuddle for warmth and need soft sweaters or heated beds when temperatures drop. Protecting their skin from direct sunlight is also vital to prevent sunburn.</p>
            <div class="space-y-4">
                <div class="flex items-center gap-5 p-5 bg-rose-50 rounded-2xl border-l-8 border-rose-500 product-card">
                    <span class="text-2xl">🧥</span>
                    <span class="text-lg font-bold text-rose-900">Seamless Cotton Sweaters</span>
                </div>
                <div class="flex items-center gap-5 p-5 bg-rose-50 rounded-2xl border-l-8 border-rose-500 product-card">
                    <span class="text-2xl">☀️</span>
                    <span class="text-lg font-bold text-rose-900">Cat-Safe Sunscreen Mists</span>
                </div>
            </div>
        </div>
    </div>
...
<section class="section-spacing px-6 py-16 bg-[#fafafa]">
    <div class="feeding-section-wrapper reveal">
        <div class="mb-10 text-center">
            ...
            <p class="text-gray-500 font-medium">Caloric schedule for a high-energy <?php echo $breed; ?>.</p>
        </div>
                ...
                <table class="w-full text-left border-collapse text-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr class="hover:bg-emerald-50/50 transition-colors">
                            ...
                            <td class="px-6 py-5">70-90g high-calorie</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">5-6 Meals</span></td>
                            <td class="px-6 py-5 italic text-sm">Frequent small meals prevent blood sugar drops</td>
                        </tr>
                        <tr class="hover:bg-emerald-50/50 transition-colors">
                            <td class="px-6 py-5 font-bold">Adult (1+ Years)</td>
                            <td class="px-6 py-5">80-110g premium</td>
                            <td class="px-6 py-5 text-center"><span class="meal-pill">3-4 Meals</span></td>
                            <td class="px-6 py-5 italic text-sm">Rich in fatty acids for skin elasticity</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="mt-8 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
            ...
            <p class="text-gray-600 text-sm"><strong>Note:</strong> Sphynx cats eat more than furred cats of the same size. Always provide access to fresh water!</p>
        </div>
    </div>
</section>

<section class="section-spacing px-6 bg-rose-50">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-20">
        <div class="md:w-1/2 reveal">
            <h2 class="text-5xl font-bold text-rose-800 mb-8 italic">Managing Natural Oils</h2>
            <p class="text-xl text-gray-600 mb-10 leading-relaxed">The skin of a Sphynx produces oils that are usually absorbed by fur. Without it, oils can stain furniture and lead to skin infections. Regular cleaning of nail beds and skin folds is mandatory for their comfort.</p>
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-white p-4 rounded-2xl shadow-md border-l-4 border-rose-500">
                    <p class="font-bold text-sm">Oil-Absorbent Bedding</p>
                </div>
                <div class="bg-white p-4 rounded-2xl shadow-md border-l-4 border-rose-500">
                    <p class="font-bold text-sm">Daily Skin Wipes</p>
                </div>
            </div>
        </div>
        <div class="md:w-1/2 reveal">
            <img src="uploads/breeds/inner/sphynx_grooming.jpg" class="rounded-[4rem] shadow-2xl border-8 border-white" alt="Sphynx Skin Care">
        </div>
    </div>
</section>
...
<section class="bg-purple-50 section-spacing px-6">
    <div class="max-w-5xl mx-auto flex flex-col items-center text-center reveal">
        <h2 class="text-5xl font-bold text-purple-900 mb-8 italic">New Sphynx Kitten? Get Setup!</h2>
        <div class="bg-white p-12 rounded-[4rem] shadow-2xl flex flex-col md:flex-row gap-12 items-center">
            <img src="https://images.pexels.com/photos/11059530/pexels-photo-11059530.jpeg" class="w-64 h-64 rounded-full object-cover border-8 border-purple-100">
            <div class="text-left">
                <h3 class="text-2xl font-bold mb-4">The <?php echo $brand; ?> Sphynx Kit</h3>
                <ul class="text-gray-600 space-y-3 mb-8">
                    <li>✓ Self-warming orthopedic kitten beds</li>
                    <li>✓ High-fat kitten growth energy formula</li>
                    <li>✓ Alcohol-free facial & body wipes</li>
                </ul>
...
<section class="section-spacing px-6 bg-sky-100">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        <div class="md:w-1/2 reveal"> 
            <img src="uploads/breeds/inner/cat_vet_heart.jpg" class="w-full h-auto rounded-[3rem] shadow-2xl transform hover:scale-105 transition-transform duration-500" alt="Sphynx Vet Care">
        </div>
        <div class="md:w-1/2 reveal">
            <h2 class="text-3xl lg:text-4xl font-bold text-blue-800 mb-10 italic leading-tight">Advanced wellness for a unique cat</h2>
            <div class="space-y-6">
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-sky-500 product-card flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-lg">Hypertrophic Cardiomyopathy (HCM) is a concern; regular scans are advised.</p>
                    </div>
                </div>
                <div class="bg-white p-8 rounded-[2.5rem] shadow-xl border-r-8 border-sky-500 product-card flex items-center gap-6">
                    <div class="bg-sky-100 p-5 rounded-full text-4xl shadow-inner">🌡️</div>
                    <div>
                        <h4 class="font-bold text-xl text-gray-800">Urticaria Pigmentosa</h4>
                        <p class="text-gray-500 text-lg">Watch for skin rashes and consult your vet for cat-safe topical treatments.</p>
                    </div>
                </div>
            </div>
        </div>
